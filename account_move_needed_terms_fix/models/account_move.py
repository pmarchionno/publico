...
class AccountMove(models.Model):
    ...
    def _compute_needed_terms(self):
        ...
        Bug: The field needed_terms (fields.Binary) sometimes returns False
        instead of a dictionary, causing 'bool' object is not subscriptable error.
        ...
        for invoice in self.with_context(bin_size=False):
            ...
            # ALWAYS initialize needed_terms as empty dict
            invoice.needed_terms = {}
            invoice.needed_terms_dirty = True
            
            # Only process invoices with lines
            if not (invoice.is_invoice(True) and invoice.invoice_line_ids):
                # For non-invoices or invoices without lines, needed_terms stays as {}
                continue
            ...
            if invoice.invoice_payment_term_id:
                ...
                for term_line in invoice_payment_terms['line_ids']:
                    ...
                    # FIX: Verify needed_terms is a dict before accessing
                    ...
                    if key not in invoice.needed_terms:
                        ...
                        # Key exists but value is not a dict, replace it
                        invoice.needed_terms[key] = values
            else:
