    ...
    def _compute_price_unit_and_date_planned_and_name(self):
        ...
        for line in self:
            ...
            if not seller:
                ...
                # Hay seller - usar su precio SIN redondear
                # Intentar usar net_price si existe (de product_replenishment_cost)
                seller_price = getattr(seller, 'net_price', None) or seller.price
